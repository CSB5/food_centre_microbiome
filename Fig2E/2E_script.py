...
new_counts, new_mddf = load(new_dataset)

# %% Train old, test new (Fig2E)
...
# %% Train old + 1 new, test other new (Fig2G)
...
## p-value
### compare differences for at xaxis = 20 features
